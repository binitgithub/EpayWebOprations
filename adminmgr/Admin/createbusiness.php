            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
					<div class="modal-header">
						<h5 id="edit-agent-modal-title" class="modal-title">Create Business</h5>
                ...
                <div class="modal-body">
                    <form id="update-agent-form" method="POST" autocomplete="off">
                            <div class="form-group">
                                <label for="agentid"> Are you sure you want to create this business? </label>
                            </div>
                    </form>
                </div>
...
<script src="assets/js/createbusiness.js"></script>
<?php 
